...
const collectEmployees = function () {
  ...
  while (nextEmployee) {
    ...
    //Ask user for their employee choice
    employee.firstName = window.prompt("Employee First Name");
    console.log(employee)

    employee.lastName = window.prompt("Employee Last Name");
    console.log(employee)

    employee.salary = parseInt(window.prompt("Employee Salary"));
    console.log(employee)
